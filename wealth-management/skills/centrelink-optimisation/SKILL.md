...
description: Model Age Pension eligibility and optimise asset structuring to maximise Centrelink entitlements. Covers income test, assets test, deeming rates, gifting rules, and the interaction between super, investments, and pension eligibility. Triggers on "centrelink", "age pension", "means testing", "deeming rates", "pension eligibility", "assets test", or "income test".
...
- Gifting plan (if applicable, with 5-year tracking)
...
- All advice relating to Centrelink optimisation must comply with Best Interest Duty and be documented in an SOA
